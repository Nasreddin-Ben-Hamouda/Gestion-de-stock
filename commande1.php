...
<body>
	...
	<div class="col-sm-12">
		...
		<div class="col-md-6 heade-right">
			...
			<p><span><i class="fa fa-angle-right"></i></span><a href="moncompte.php">Mon Compte </a><span><i class="fa fa-angle-right"></i></span> Mes commandes</p>
		</div>
	</div>
	</div>
		...
		<div class="container">
	       ...
	       ?>
			...
			<div class="col-md-8 about-center">
				...
				<h1 class="page-heading">Mes commandes</h1>
				<p class="pg-modifl">Vous trouverez ici vos commandes passées depuis la création de votre compte</p>
				  ...
				  <?php
					...
					$reponse = $DB_con->query("SELECT * FROM commande,produit,users
           			  where commande.confirme='oui' and commande.user_id=users.user_id and commande.pro_id=produit.id and commande.user_id='$numuser'");
                   	  $nb= $reponse->rowCount();
                    if($nb>0){
					echo '
					...
					<a href="moncompte2.php" class="btn-pcom" style="background-color:#4682B4">Retour à votre compte</a>
				   	 <a href="acceuille.php" class="btn-pcom" style="background-color:#4682B4">Accueil</a>';
						}else{
							echo '<div class="col-sm-12 alertmsg"><p>Vous n\'avez pas encore ajoute des commandes<p></div>';
						}
